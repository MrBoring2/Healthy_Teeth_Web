        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Home = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    ApartmentNuber = table.Column<int>(type: "integer", nullable: false),
                    Phone = table.Column<string>(type: "character varying(11)", maxLength: 11, nullable: false),
                    PassportNumber = table.Column<string>(type: "character varying(4)", maxLength: 4, nullable: false),
                    PassportCode = table.Column<string>(type: "character varying(6)", maxLength: 6, nullable: false),
                    MedicalPolicy = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisirtTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    VisitPurpose = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    VisitDiagnos = table.Column<string>(type: "text", nullable: true),
                    VisitObjectively = table.Column<string>(type: "text", nullable: true),
                    EmployeeId = table.Column<int>(type: "integer", nullable: false),
                    PatientId = table.Column<int>(type: "integer", nullable: false),
                    VisitStatusId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceToVisits", x => new { x.ServiceId, x.VisitId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceToVisits_VisitId",
